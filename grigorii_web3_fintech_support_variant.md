...
- Wallet or transaction troubleshooting roles
- Integration support for money-moving products
- Customer success roles with incident ownership

## Tailoring Priorities
- Keep Mover Bridge bullets above other domain proof when the JD stresses incidents, wallets, funds, or compliance-sensitive communication.
- Keep Heapp projects as differentiators, not as the identity center.
- Prioritize skills like escalation management, bridge incidents, on-chain troubleshooting, and trust-preserving communication.
